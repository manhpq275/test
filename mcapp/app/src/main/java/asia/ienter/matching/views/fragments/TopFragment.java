...
import asia.ienter.matching.views.activities.ProfileActivity;
import asia.ienter.matching.views.activities.SettingActivity;
import asia.ienter.matching.views.adapters.TopAdapter;
import asia.ienter.matching.views.dialogs.DialogLiked;
 ...
 */
public class TopFragment extends BaseFragment implements ITopActionBarCallback,ITopViewCallback {
    ...
    public void OnItemClickLike(int position) {
        ...
        new DialogLiked(this.homeActivity).show();
