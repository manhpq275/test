        ...
        if(!title.isEmpty()) {
            ...
            holder.layoutContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new ReplaceFragment().replaceWithAnimation(((AdvanceSearchActivity)mActivity).getSupportFragmentManager(), AboutDetailFragment.newInstance(), R.id.layoutContent, R.anim.enter_from_right,
                            R.anim.hold,
                            R.anim.hold,
